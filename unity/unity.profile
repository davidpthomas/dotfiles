...
s0_active_shadow_color = #00000000
s0_active_shadow_x_offset = 16
s0_active_shadow_y_offset = 16
s0_inactive_shadow_radius = 13.000000
s0_inactive_shadow_opacity = 0.800000
s0_inactive_shadow_color = #00000000
s0_inactive_shadow_x_offset = 16
s0_inactive_shadow_y_offset = 16
...
s0_reveal_trigger = 0
s0_show_launcher = <Alt>Caps_Lock
s0_keyboard_focus = <Alt>a
...
s0_icon_size = 64
s0_edge_responsiveness = 1.000000
s0_reveal_pressure = 1
s0_overcome_pressure = 5
s0_decay_rate = 15
s0_stop_velocity = 25
...
[core]
s0_active_plugins = core;composite;opengl;compiztoolbox;decor;place;imgpng;shift;session;gnomecompat;grid;move;mousepoll;resize;vpswitch;regex;wobbly;animation;workarounds;fade;cube;rotate;scale;expo;unitymtgrabhandles;ezoom;unityshell;
...
s0_command_terminal = gnome-terminal --window-with-profile=GreenScreen --hide-menubar
s0_run_command_terminal_key = <Alt>Shift_L
...
s0_skydome_gradient_end_color = #949ce1ff
